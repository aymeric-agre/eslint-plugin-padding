...
`,
    ...
    },
    {
      ...
      options: [
        ...
        { blankLine: "never", prev: { type: AST_NODE_TYPES.EmptyStatement }, next: "*" },
      ],
    },
...

    {
      ...
      options: [
        { blankLine: "never", prev: "*", next: "*" },
        { blankLine: "always", prev: { keyword: "block-like", inline: false }, next: "*" },
      ],
    },
    {
      code: "if(a){}\nfoo()",
...

    {
      ...
      options: [
        { blankLine: "never", prev: "*", next: "*" },
        { blankLine: "always", prev: { type: AST_NODE_TYPES.BlockStatement }, next: "*" },
      ],
    },
    {
      code: "{\n}\n\nfoo()",
...

    {
      ...
      options: [
        { blankLine: "never", prev: "*", next: "*" },
        { blankLine: "always", prev: { type: AST_NODE_TYPES.EmptyStatement }, next: "*" },
      ],
    },
    {
      code: "1;\nfoo()",
    ...
    {
      code: "foo()\n\nfoo(\n\tx,\n\ty\n)",
      options: [{ blankLine: "always", prev: "*", next: { keyword: "expression", inline: false } }],
    },
    {
      code: "foo()\nfoo()",
      options: [{ blankLine: "always", prev: "*", next: { keyword: "expression", inline: false } }],
    },
    {
      ...
      options: [
        { blankLine: "always", prev: { keyword: "expression", inline: false }, next: "return" },
      ],
    },
    {
      code: "() => {\n\tsomeArray.forEach(\n\t\tx => doSomething(x)\n\t);\n\n\treturn theThing;\n}",
...

    {
      ...
      options: [
        { blankLine: "never", prev: "*", next: "*" },
        { blankLine: "always", prev: { type: AST_NODE_TYPES.FunctionDeclaration }, next: "*" },
      ],
    },
    {
...

    {
      ...
      options: [
        { blankLine: "never", prev: "*", next: "*" },
        { blankLine: "always", prev: { keyword: "const", inline: false }, next: "*" },
      ],
    },
    {
      code: "const a=1\n\nconst b={\nc:2,\nd:3\n}",
      options: [
        { blankLine: "never", prev: "*", next: "*" },
        { blankLine: "always", prev: "*", next: { keyword: "const", inline: false } },
      ],
    },
    {
      code: "const a=1\nconst b=2",
...

    {
      ...
      options: [
        { blankLine: "never", prev: "*", next: "*" },
        { blankLine: "always", prev: { keyword: "let", inline: false }, next: "*" },
      ],
    },
    {
      code: "let a=1\n\nlet b={\nc:2,\nd:3\n}",
      options: [
        { blankLine: "never", prev: "*", next: "*" },
        { blankLine: "always", prev: "*", next: { keyword: "let", inline: false } },
      ],
    },
    {
      code: "let a=1\nlet b=2",
...

    {
      ...
      options: [
        { blankLine: "never", prev: "*", next: "*" },
        { blankLine: "always", prev: { keyword: "var", inline: false }, next: "*" },
      ],
    },
    {
      code: "var a=1\n\nvar b={\nc:2,\nd:3\n}",
      options: [
        { blankLine: "never", prev: "*", next: "*" },
        { blankLine: "always", prev: "*", next: { keyword: "var", inline: false } },
      ],
    },
    {
      code: "var a=1\nvar b=2",
...

    {
      ...
      options: [
        { blankLine: "never", prev: "*", next: "*" },
        { blankLine: "always", prev: { keyword: "const", inline: true }, next: "*" },
      ],
    },
    {
      code: "const a=1\n\nconst b=2",
      options: [
        { blankLine: "never", prev: "*", next: "*" },
        { blankLine: "always", prev: "*", next: { keyword: "const", inline: true } },
      ],
    },
    {
      code: "const a={\nb:1,\nc:2\n}\nconst d={\ne:3,\nf:4\n}",
...

    {
      ...
      options: [
        { blankLine: "never", prev: "*", next: "*" },
        { blankLine: "always", prev: { keyword: "let", inline: true }, next: "*" },
      ],
    },
    {
      code: "let a=1\n\nlet b=2",
      options: [
        { blankLine: "never", prev: "*", next: "*" },
        { blankLine: "always", prev: "*", next: { keyword: "let", inline: true } },
      ],
    },
    {
      code: "let a={\nb:1,\nc:2\n}\nlet d={\ne:3,\nf:4\n}",
...

    {
      ...
      options: [
        { blankLine: "never", prev: "*", next: "*" },
        { blankLine: "always", prev: { keyword: "var", inline: true }, next: "*" },
      ],
    },
    {
      code: "var a=1\n\nvar b=2",
      options: [
        { blankLine: "never", prev: "*", next: "*" },
        { blankLine: "always", prev: "*", next: { keyword: "var", inline: true } },
      ],
    },
    {
      code: "var a={\nb:1,\nc:2\n}\nvar d={\ne:3,\nf:4\n}",
...
(b || c).doSomething();
    ...
    {
      code: "var i = 0;\nwhile (i < 100) {\nif(i % 2 === 0) {continue;}\n++i;\n}",
      options: [{ blankLine: "always", prev: { keyword: "block-like", inline: false }, next: "*" }],
    },
    {
      ...
      options: [
        {
          blankLine: "always",
          prev: "*",
          next: ["if", "for", "return", "switch", "case", "break", "throw", "while", "default"],
        },
      ],
    },
    {
...
`,
...

    {
      code: "{}\n\nfoo()",
      output: "{}\nfoo()",
      options: [{ blankLine: "never", prev: { type: AST_NODE_TYPES.BlockStatement }, next: "*" }],
      errors: [{ messageId: "unexpectedBlankLine" }],
    },
    {
      code: "{}\nfoo()",
      output: "{}\n\nfoo()",
      options: [{ blankLine: "always", prev: { type: AST_NODE_TYPES.BlockStatement }, next: "*" }],
      errors: [{ messageId: "expectedBlankLine" }],
    },
...

    {
      code: ";\n\nfoo()",
      output: ";\nfoo()",
      options: [{ blankLine: "never", prev: { type: AST_NODE_TYPES.EmptyStatement }, next: "*" }],
      errors: [{ messageId: "unexpectedBlankLine" }],
    },
    {
      code: ";\nfoo()",
      output: ";\n\nfoo()",
      options: [{ blankLine: "always", prev: { type: AST_NODE_TYPES.EmptyStatement }, next: "*" }],
      errors: [{ messageId: "expectedBlankLine" }],
    },
...

    {
      code: "foo()\n\nfoo(\n\tx,\n\ty\n)",
      output: "foo()\nfoo(\n\tx,\n\ty\n)",
      options: [{ blankLine: "never", prev: "*", next: { keyword: "expression", inline: false } }],
      errors: [{ messageId: "unexpectedBlankLine" }],
    },
    {
      code: "foo()\nfoo(\n\tx,\n\ty\n)",
...

    {
      ...
      output: "function foo(){}\nfoo()",
      options: [
        { blankLine: "never", prev: { type: AST_NODE_TYPES.FunctionDeclaration }, next: "*" },
      ],
      errors: [{ messageId: "unexpectedBlankLine" }],
    },
    {
...

    {
      code: "const a={\nb:1,\nc:2\n}\n\nconst d=3",
      output: "const a={\nb:1,\nc:2\n}\nconst d=3",
      options: [{ blankLine: "never", prev: { keyword: "const", inline: false }, next: "*" }],
      errors: [{ messageId: "unexpectedBlankLine" }],
    },
    {
      code: "const a={\nb:1,\nc:2\n}\nconst d=3",
      output: "const a={\nb:1,\nc:2\n}\n\nconst d=3",
      options: [{ blankLine: "always", prev: { keyword: "const", inline: false }, next: "*" }],
      errors: [{ messageId: "expectedBlankLine" }],
    },
    {
      code: "const a=1\n\nconst b={\nc:2,\nd:3\n}",
      output: "const a=1\nconst b={\nc:2,\nd:3\n}",
      options: [{ blankLine: "never", prev: "*", next: { keyword: "const", inline: false } }],
      errors: [{ messageId: "unexpectedBlankLine" }],
    },
    {
      code: "const a=1\nconst b={\nc:2,\nd:3\n}",
      output: "const a=1\n\nconst b={\nc:2,\nd:3\n}",
      options: [{ blankLine: "always", prev: "*", next: { keyword: "const", inline: false } }],
      errors: [{ messageId: "expectedBlankLine" }],
    },
...

    {
      code: "let a={\nb:1,\nc:2\n}\n\nlet d=3",
      output: "let a={\nb:1,\nc:2\n}\nlet d=3",
      options: [{ blankLine: "never", prev: { keyword: "let", inline: false }, next: "*" }],
      errors: [{ messageId: "unexpectedBlankLine" }],
    },
    {
      code: "let a={\nb:1,\nc:2\n}\nlet d=3",
      output: "let a={\nb:1,\nc:2\n}\n\nlet d=3",
      options: [{ blankLine: "always", prev: { keyword: "let", inline: false }, next: "*" }],
      errors: [{ messageId: "expectedBlankLine" }],
    },
    {
      code: "let a=1\n\nlet b={\nc:2,\nd:3\n}",
      output: "let a=1\nlet b={\nc:2,\nd:3\n}",
      options: [{ blankLine: "never", prev: "*", next: { keyword: "let", inline: false } }],
      errors: [{ messageId: "unexpectedBlankLine" }],
    },
    {
      code: "let a=1\nlet b={\nc:2,\nd:3\n}",
      output: "let a=1\n\nlet b={\nc:2,\nd:3\n}",
      options: [{ blankLine: "always", prev: "*", next: { keyword: "let", inline: false } }],
      errors: [{ messageId: "expectedBlankLine" }],
    },
...

    {
      code: "var a={\nb:1,\nc:2\n}\n\nvar d=3",
      output: "var a={\nb:1,\nc:2\n}\nvar d=3",
      options: [{ blankLine: "never", prev: { keyword: "var", inline: false }, next: "*" }],
      errors: [{ messageId: "unexpectedBlankLine" }],
    },
    {
      code: "var a={\nb:1,\nc:2\n}\nvar d=3",
      output: "var a={\nb:1,\nc:2\n}\n\nvar d=3",
      options: [{ blankLine: "always", prev: { keyword: "var", inline: false }, next: "*" }],
      errors: [{ messageId: "expectedBlankLine" }],
    },
    {
      code: "var a=1\n\nvar b={\nc:2,\nd:3\n}",
      output: "var a=1\nvar b={\nc:2,\nd:3\n}",
      options: [{ blankLine: "never", prev: "*", next: { keyword: "var", inline: false } }],
      errors: [{ messageId: "unexpectedBlankLine" }],
    },
    {
      code: "var a=1\nvar b={\nc:2,\nd:3\n}",
      output: "var a=1\n\nvar b={\nc:2,\nd:3\n}",
      options: [{ blankLine: "always", prev: "*", next: { keyword: "var", inline: false } }],
      errors: [{ messageId: "expectedBlankLine" }],
    },
...

    {
      code: "const a=1\n\nconst b=2",
      output: "const a=1\nconst b=2",
      options: [{ blankLine: "never", prev: { keyword: "const", inline: true }, next: "*" }],
      errors: [{ messageId: "unexpectedBlankLine" }],
    },
    {
      code: "const a=1\nconst b=2",
      output: "const a=1\n\nconst b=2",
      options: [{ blankLine: "always", prev: { keyword: "const", inline: true }, next: "*" }],
      errors: [{ messageId: "expectedBlankLine" }],
    },
    {
      code: "const a=1\n\nconst b=2",
      output: "const a=1\nconst b=2",
      options: [{ blankLine: "never", prev: "*", next: { keyword: "const", inline: true } }],
      errors: [{ messageId: "unexpectedBlankLine" }],
    },
    {
      code: "const a=1\nconst b=2",
      output: "const a=1\n\nconst b=2",
      options: [{ blankLine: "always", prev: "*", next: { keyword: "const", inline: true } }],
      errors: [{ messageId: "expectedBlankLine" }],
    },
...

    {
      code: "let a=1\n\nlet b=2",
      output: "let a=1\nlet b=2",
      options: [{ blankLine: "never", prev: { keyword: "let", inline: true }, next: "*" }],
      errors: [{ messageId: "unexpectedBlankLine" }],
    },
    {
      code: "let a=1\nlet b=2",
      output: "let a=1\n\nlet b=2",
      options: [{ blankLine: "always", prev: { keyword: "let", inline: true }, next: "*" }],
      errors: [{ messageId: "expectedBlankLine" }],
    },
    {
      code: "let a=1\n\nlet b=2",
      output: "let a=1\nlet b=2",
      options: [{ blankLine: "never", prev: "*", next: { keyword: "let", inline: true } }],
      errors: [{ messageId: "unexpectedBlankLine" }],
    },
    {
      code: "let a=1\nlet b=2",
      output: "let a=1\n\nlet b=2",
      options: [{ blankLine: "always", prev: "*", next: { keyword: "let", inline: true } }],
      errors: [{ messageId: "expectedBlankLine" }],
    },
...

    {
      code: "var a=1\n\nvar b=2",
      output: "var a=1\nvar b=2",
      options: [{ blankLine: "never", prev: { keyword: "var", inline: true }, next: "*" }],
      errors: [{ messageId: "unexpectedBlankLine" }],
    },
    {
      code: "var a=1\nvar b=2",
      output: "var a=1\n\nvar b=2",
      options: [{ blankLine: "always", prev: { keyword: "var", inline: true }, next: "*" }],
      errors: [{ messageId: "expectedBlankLine" }],
    },
    {
      code: "var a=1\n\nvar b=2",
      output: "var a=1\nvar b=2",
      options: [{ blankLine: "never", prev: "*", next: { keyword: "var", inline: true } }],
      errors: [{ messageId: "unexpectedBlankLine" }],
    },
    {
      code: "var a=1\nvar b=2",
      output: "var a=1\n\nvar b=2",
      options: [{ blankLine: "always", prev: "*", next: { keyword: "var", inline: true } }],
      errors: [{ messageId: "expectedBlankLine" }],
    },
